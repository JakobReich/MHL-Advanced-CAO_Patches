...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.0, 599.0, 199.0, 20.0 ],
					"text" : "INIT (initialize) by muting everything"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 599.0, 59.0, 22.0 ],
					"text" : "mute 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 44.421235138705413, 551.5, 202.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 18.921235138705413, 556.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.921235138705413, 632.5, 60.0, 22.0 ],
					"text" : "s mute.all"
				}
...
,
					"patching_rect" : [ 600.0, 338.0, 75.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 688.23828382838326, 411.0, 59.0, 20.0 ],
					"text" : "busymap"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 576.0, 411.0, 59.0, 20.0 ],
					"text" : "mutemap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 512.0, 338.0, 79.0, 22.0 ],
					"text" : "prepend note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 688.23828382838326, 435.0, 64.0, 22.0 ],
					"text" : "0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 577.571617161716517, 435.0, 64.0, 22.0 ],
					"text" : "1 1 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 511.952475247524944, 435.0, 54.0, 22.0 ],
					"text" : "*~ 0.707"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 867.0, 368.0, 150.0, 89.0 ],
					"text" : "Always use the DOUBLE Number of voices, which appear in the musical structure - so short notes can't steal the voice and produce a click"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 562.202475247524944, 551.0, 258.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 96.047524752475056, 421.25, 412.0, 89.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 562.202475247524944, 536.0, 63.0, 20.0 ],
					"text" : "<ezdac~>",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 511.952475247524944, 536.0, 48.25, 48.25 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 649.952475247524944, 489.0, 78.0, 20.0 ],
					"text" : "<live.gain~>",
					"textcolor" : [ 0.870588, 0.415686, 0.062745, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 511.952475247524944, 479.0, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "", "", "" ],
					"patching_rect" : [ 511.952475247524944, 368.0, 351.0, 34.0 ],
					"text" : "poly~ simple.voice.polyCore_v01 4"
				}
...
, 			{
				"name" : "simple.voice.polyCore_v01.maxpat",
				"bootpath" : "~/Documents/Studium/Schulmusik/Sound Art/MHL-Advanced-CAO_Patches/231017 bach-poly-boiler-patches-master",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
